...
<!-- ==========================表单========= -->
                            ...
                            action="${pageContext.request.contextPath }/rule_update.action"
            ...
            value="<s:property value="model.id"/>" />
                                    <div class="span10 field-box">
                                        ...
                                        value="<s:property value="model.year"/>"/>
                                    </div>
                                    <div class="span10 field-box">
                                        <label>奖学金等级:</label>
                                        <input name="level" class="span7" type="text" 
                                        value="<s:property value="model.level"/>"/>
                                    </div>
                                    
                                     <div class="span10 field-box">
                                        <label>奖学金人数:</label>
                                        <input name="stunum" class="span7" type="text" 
                                        value="<s:property value="model.stunum"/>"/>
                                    </div>
