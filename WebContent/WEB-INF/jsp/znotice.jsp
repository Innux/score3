                ...
                <div class="table-wrapper products-table section">
                    ...
                    <div class="row-fluid filter-block">
                        <div class="pull-right">
                            <a href="${ pageContext.request.contextPath }/notice_addPage.action" class="btn-flat success new-product" >+ 添加公告</a>
                        </div>
                    </div>
...
<a href="${ pageContext.request.contextPath }/notice_showContent.action?id=<s:property value="#notice.id"/>" target="_blank" class="name" >
									...
									<td>
<a href="${ pageContext.request.contextPath }/notice_edit.action?id=<s:property value="#notice.id"/>">编辑</a>
<a href="${ pageContext.request.contextPath }/notice_delete.action?id=<s:property value="#notice.id"/>">删除</a>
									</td>
								</tr>
							</s:iterator>		
...
<a href="${ pageContext.request.contextPath }/notice_findByPage.action?page=<s:property value="pageBean.page-1"/>">&#8249;</a>
						</s:if>
						<s:else>
						<a href="#">&#8249;</a>
						</s:else>
					...
					<!-- 选页 -->
						...
						<s:bean name="org.apache.struts2.util.Counter" id="counter">
						    ...
						    <s:iterator>
						        <li><a href="${ pageContext.request.contextPath }/notice_findByPage.action?page=<s:property/>"><s:property/></a></li>
						    </s:iterator>
						</s:bean>
					<!-- 选页end -->
					<!-- 下一页 -->
