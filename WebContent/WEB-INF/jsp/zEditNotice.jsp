            ...
            <div id="pad-wrapper" class="form-page">
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span8 column">
                        <form  action="${pageContext.request.contextPath }/notice_save.action"
                             method="post" novalidate="novalidate">
                            <div class="field-box">
                                <label>标题:</label>
                                <input name="title" id="iTitle" class="span8 inline-input" type="text" placeholder="请输入标题" maxlength="20" />
                            </div>
                            ...
                            <div class="field-box">
                                <label>内容:</label>
                                <textarea name="content" id="iTxt" class="span8" rows="20"></textarea>
                            </div>
